        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ marginBottom: 24 }}>
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' }}>
                    {[
                        { label: 'Heart Rate', value: '72 bpm', icon: '❤️', trend: 'Normal' },
                        { label: 'Blood Pressure', value: '120/80', icon: '🩺', trend: 'Normal' },
                        { label: 'Blood Sugar', value: '95 mg/dL', icon: '🩸', trend: 'Normal' },
                        { label: 'Weight', value: '72 kg', icon: '⚖️', trend: 'Stable' },
            ...
            <RazorpayCheckout visible={showPayment} amount={2800} onClose={() => setShowPayment(false)} onSuccess={handleSuccess} />
        </ScrollView>
    );
}
