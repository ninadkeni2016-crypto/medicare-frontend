...
import { View, Text, TextInput, TouchableOpacity, ScrollView, Image, Animated, KeyboardAvoidingView, Platform, Dimensions, ActivityIndicator, Modal } from 'react-native';
...
export default function LoginPage() {
    ...
    const handleForgotPassword = () => {
        setForgotSent(true);
        setTimeout(() => { setForgotSent(false); setShowForgotPassword(false); }, 3000);
    };
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, backgroundColor: '#fff' }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                ...
                <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }], padding: 24, paddingTop: 28 }}>
                    ...
                    <View style={{ width: '100%', backgroundColor: '#fff', borderRadius: 20, padding: 20, borderWidth: 1, borderColor: '#f1f5f9', shadowColor: '#0284c7', shadowOpacity: 0.06, shadowOffset: { width: 0, height: 4 }, shadowRadius: 16, elevation: 3 }}>
                        ...
                        <TouchableOpacity onPress={handleLogin} activeOpacity={0.8} disabled={isLoading} style={{ width: '100%', backgroundColor: '#0284c7', paddingVertical: 16, borderRadius: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, shadowColor: '#0284c7', shadowOpacity: 0.3, shadowOffset: { width: 0, height: 4 }, shadowRadius: 8, elevation: 4 }}>
                            {isLoading ? (
                    ...
                    {/* Biometric Login */}
                    {!isSignUp && (
                        <TouchableOpacity onPress={handleLogin} activeOpacity={0.7} style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, borderRadius: 14, backgroundColor: '#f0f9ff', borderWidth: 1, borderColor: '#bae6fd', marginBottom: 20 }}>
            ...
            <Modal visible={showOTP} transparent animationType="slide">
                <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' }}>
                    <View style={{ backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40 }}>
                        ...
                        <Text style={{ fontSize: 14, fontWeight: '600', color: '#0284c7', marginBottom: 24 }}>+91 98765 43210</Text>
                ...
                <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 24 }}>
                    <View style={{ backgroundColor: '#fff', borderRadius: 24, padding: 24 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
                            <Text style={{ fontSize: 20, fontWeight: '700', color: '#0f172a' }}>Reset Password</Text>
                            <TouchableOpacity onPress={() => { setShowForgotPassword(false); setForgotSent(false); }}><X size={20} color="#94a3b8" /></TouchableOpacity>
                        </View>
                        ...
                        {forgotSent ? (
                            <View style={{ alignItems: 'center', paddingVertical: 20 }}>
                                ...
                                <Text style={{ fontSize: 16, fontWeight: '600', color: '#0f172a', marginBottom: 8 }}>Email Sent!</Text>
                                <Text style={{ fontSize: 14, color: '#64748b', textAlign: 'center' }}>Check your inbox for a password reset link.</Text>
                            </View>
                        ) : (
                            <>
                                <Text style={{ fontSize: 14, color: '#64748b', marginBottom: 16 }}>Enter your email and we'll send you a reset link.</Text>
                                <View style={{ flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0', borderRadius: 12, backgroundColor: '#f8fafc', paddingHorizontal: 14, marginBottom: 16 }}>
                                    <Mail size={16} color="#94a3b8" />
                                    <TextInput value={forgotEmail} onChangeText={setForgotEmail} placeholder="your@email.com" placeholderTextColor="#94a3b8" autoCapitalize="none" keyboardType="email-address" style={{ flex: 1, paddingVertical: 12, paddingHorizontal: 10, color: '#0f172a', fontSize: 14 }} />
                                </View>
                                <TouchableOpacity onPress={handleForgotPassword} activeOpacity={0.7} style={{ backgroundColor: '#0284c7', paddingVertical: 16, borderRadius: 14, alignItems: 'center' }}>
