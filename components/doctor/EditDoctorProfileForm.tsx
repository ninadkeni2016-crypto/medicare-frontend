...
export default function EditDoctorProfileForm({ onBack }: { onBack: () => void }) {
    ...
    // Defaulting to Dr. Sameer's info
    const [formData, setFormData] = useState({
        name: 'Dr. Sameer Mahadik',
        email: 'sameer.mahadik@medicare.com',
        phone: '+91 98765 43210',
        location: 'Apollo Hospital, Mumbai',
        specialization: 'Cardiologist',
        experience: '12',
        consultationFee: '500',
        bio: 'Experienced Cardiologist with a demonstrated history of working in the medical practice industry. Skilled in Clinical Research, Medical Education, Pediatrics, Medicine, and Clinical Trials.',
    });
    ...
    return (
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            ...
            {/* Bottom Actions */}
            <View style={{ padding: 16, paddingTop: 12, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#f1f5f9', flexDirection: 'row', gap: 12 }}>
